...
function Condition() {
    return (
        <div className="items-center justify-around flex p-6">
            <div className="flex-[1] basis-1/10 mx-2 flex mb-2 border-r-food-red border-solid border-r-4 justify-center items-center">
